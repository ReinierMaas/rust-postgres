...
//!
//! # #[cfg(not(feature = "named-prepared-statements"))]
//! # fn main() {}
//! # #[cfg(feature = "named-prepared-statements")]
...
//! | ------- | ----------- | ------------------ | ------- |
//! | `named-prepared-statements` | Enable APIs that implicitly create or use protocol-level named prepared statements. Disable this for poolers or platforms that do not support named prepared statements and use the typed query APIs instead. | - | yes |
...
//!
//! Disabling `named-prepared-statements` removes APIs that create or use
//! protocol-level named prepared statements. This is intended for poolers or
//! platforms that do not support named prepared statements; use the
